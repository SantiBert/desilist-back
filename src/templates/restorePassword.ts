export function restorePasswordTemplate(redirectUrl: string): string {
  return `<!DOCTYPE html>
                      ...
                      <tr>
                          <td align="center" valign="top">
                              <p class="main-text" style=" color:#575A63; ">
                                We have sent you this email since you requested to change your password, click on the following link to restore it.
                              </p>
                          </td>
                      </tr>
                      <tr>
