export function activateAccountTemplate(redirectUrl: string): string {
  return `<!DOCTYPE html>
          ...
          <tr>
              <td align="center" valign="top">
                  <table width="700px" cellspacing="0" cellpading="0" border="0">
                      ...
                      <tr>
                          <td align="center" valign="top">
                              <p class="main-text" style="color:#575A63; ">
                                Please click on the following link to activate it
                              </p>
                          </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td align="center" valign="top">
                              <p style='padding-top:40px;'><strong>This confirmation email is only valid for 30 minutes!</strong>
                              <br>After 30 minutes, you have to come back to the website, try to log in with your account,
                              <br>and you will receive a new activation email!</p>
                          </td>
                      </tr>
                      <tr>
